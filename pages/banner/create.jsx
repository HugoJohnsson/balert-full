...
import { withAuthSync, getToken } from '../../utils/auth'
...
const Create = () => {
  ...
  const [text, setText] = useState('This is a live view of your banner');
  const [colorHex, setColorHex] = useState('#127A73');
  const [textColorHex, setTextColorHex] = useState('#fff');
  ...
  const [selectedFont, setSelectedFont] = useState('Lexend Deca');
    ...
    <Layout title="New banner">
      ...
      <section className="uk-section uk-section-muted create-section" style={{height:'170vh'}}>
  			<div className="uk-container">
  				<h2 className="uk-text-bold" style={{marginTop:'2rem'}}>Let's create a banner.</h2>
          <form onSubmit={handleSubmit}>
                    ...
                    <legend className="uk-legend">Add a link</legend>
                      ...
                      <div className="uk-margin">
                        <div style={{display:'flex', marginLeft:'auto'}}>
                          ...
                          <span style={{marginLeft:'0.3rem'}}>Open link in a new tab (if you click on the link here in development you will always be true.)</span>
                        </div>
                      </div>
            ...
            <div className="save" style={{marginTop:'3rem'}}>
              <p uk-margin="true">
                <button className="uk-button uk-button-large uk-button-primary" type="submit" style={{borderRadius:'0.1875rem'}}>Create banner</button>
                <Link href='/dashboard'><a style={{marginLeft:'0.5rem', borderRadius:'0.1875rem'}} className="uk-button uk-button-large uk-button-danger">Cancel</a></Link>
              </p>
            </div>
          </form>
  			</div>
